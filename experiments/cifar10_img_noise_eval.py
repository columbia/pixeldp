...
def run(plots_only=False):
    ...
    for model_name in ["pixeldp_resnet"]:
        for attack_norm_bound in Ls:
            for noise_after_n_layers in [-1, 0]:
    ...
    plots.plot_robust_accuracy.plot("cifar10_img_noise_robust_accuracy_argmax",
                                    baseline_model,
                                    baseline_params,
                                    _robust_models,
                                    _robust_params,
                                    x_range=(0, 0.6, 0.025),
                                    dir_name=dir_name)
    plots.plot_robust_accuracy.plot("cifar10_img_noise_robust_accuracy_softmax",
                                    baseline_model,
                                    baseline_params,
                                    _robust_models,
                                    _robust_params,
    ...
    plots.plot_accuracy_under_attack.plot("cifar10_img_noise_accuracy_under_attack_argmax",
                                          ...
                                          x_ticks=x_ticks,
                                          dir_name=dir_name)
    plots.plot_accuracy_under_attack.plot("cifar10_img_noise_accuracy_under_attack_softmax",
