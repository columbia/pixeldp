...
from datasets import cifar, svhn, svhn
import models
...
def run(plots_only=False):
    _param_dict = {
        ...
        'relu_leakiness': 0.0,
        'lrn_rate': 0.1,
        'lrn_rte_changes': [20000, 35000, 50000],
    ...
    plots.plot_robust_accuracy.plot("svhn_robust_accuracy_argmax",
                                    baseline_model,
                                    baseline_params,
                                    _robust_models,
                                    _robust_params,
                                    x_range=(0, 0.6, 0.025),
                                    dir_name=dir_name)
    plots.plot_robust_accuracy.plot("svhn_robust_accuracy_softmax",
                                    baseline_model,
                                    baseline_params,
                                    _robust_models,
                                    _robust_params,
    ...
    plots.plot_accuracy_under_attack.plot("svhn_accuracy_under_attack_argmax",
                                          ...
                                          x_ticks=x_ticks,
                                          dir_name=dir_name)
    plots.plot_accuracy_under_attack.plot("svhn_accuracy_under_attack_softmax",
